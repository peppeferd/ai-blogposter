...
export default function Post({ post, handleDeletePost }: Props) {
  ...
  return (
    <div className="w-full h-auto flex flex-col gap-4 shadow-sm p-4 rounded-xl bg-white">
      ...
      <button
        className="bg-rose-500 text-white px-4 py-2 rounded-md hover:bg-rose-600 transition-all cursor-pointer mb-11"
